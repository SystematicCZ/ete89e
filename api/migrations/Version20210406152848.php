 ...
 */
final class Version20210406152848 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, first_name, email, password, about_me, last_name FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(50) NOT NULL COLLATE BINARY, email VARCHAR(100) NOT NULL COLLATE BINARY, about_me CLOB DEFAULT NULL COLLATE BINARY, last_name VARCHAR(50) DEFAULT NULL COLLATE BINARY, password VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, first_name, email, password, about_me, last_name) SELECT id, first_name, email, password, about_me, last_name FROM __temp__user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) DEFAULT NULL, email VARCHAR(100) NOT NULL, about_me CLOB DEFAULT NULL, password VARCHAR(255) NOT NULL COLLATE BINARY)');
